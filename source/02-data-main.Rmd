...
However, that leaves the commas associated with some words! Instead, we can use a collection of different characters; the special capture symbol `[:punct:]` will capture any and all punctuation. Putting both symbols in square brackets `[...]` means "use either of these." Chaining all of this together
